//From what I can gather this is the address book of student for the teacher users
    ...
    studentList: [
      {
        ...
        instrument: "Guitar",
        image:
          "https://scontent-lga3-1.xx.fbcdn.net/v/t1.0-9/40482582_1687539791374401_1861957606596149248_n.jpg?_nc_cat=108&_nc_ohc=UYI3jh4nLKYAQneCwzUp7HEKi154WXmQobi1Ttxfl7cSo007KSqq-SrJA&_nc_ht=scontent-lga3-1.xx&oh=4de1bae06bfa24786863fa66e1447ebf&oe=5E815AC5"
      },
      {
        name: "Andrew Besos",
        city: "Queens, NY",
        ...
        image:
          "https://thumbs.dreamstime.com/t/professional-headshot-man-56247494.jpg"
      },
      {
        name: "Mary Sommers",
        city: "Manhattan, NY",
      ...
      },
      {
        ...
        instrument: "Guitar",
        image:
          "https://images.squarespace-cdn.com/content/v1/514ffe4ee4b020d11228d65c/1402503323092-B5P7NO9BACDMY45UI1N0/ke17ZwdGBToddI8pDm48kCPztTQZpDiZMOuuCfUxiyx7gQa3H78H3Y0txjaiv_0fDoOvxcdMmMKkDsyUqMSsMWxHk725yiiHCCLfrh8O1z5QPOohDIaIeljMHgDF5CVlOqpeNLcJ80NK65_fV7S1UYlQ-m0oNUh_9buvyC-f1CSdhG_dNlqULB2ZTz-ses64A-QPhXXvNcU0N8wN7BGx0g/image-asset.jpeg"
      },
      {
        name: "Tina Smith",
        city: "Manhattan, NY",
        instrument: "Triangle",
        image:
          "http://blog.scottrklinephoto.com/wp-content/uploads/2013/10/Amy_Wigdahl_Headshot_15E9688-1024x683.jpg"
      },
      {
        name: "Richard Martin",
        city: "Manhattan, NY",
      ...
      },
      {
        ...
        instrument: "Guitar",
        image:
          "https://image1.masterfile.com/getImage/Njk4LTA3NTg4MzA1ZW4uMDAwMDAwMDA=AOcI0K/698-07588305en_Masterfile.jpg"
      },
      {
        ...
        instrument: "Flute",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRYW_ycIBW5Y4UrGN_We1RKTF966PjTYfdljzk_HJochHbcq9lx"
      }
    ]
  };
        ...
        <View style={{ display: this.state.studentListDisplay }}>
          ...
          <View style={styles.searchBar}>
            <Image
              source={{
                uri:
                  "http://fa2png.io/media/icons/font-awesome/4-7-0/search/256/0/274156_none.png"
              }}
            ...
            {this.state.studentList.map(student => (
              <View key={student.name} style={styles.listContainer}>
                ...
                <View style={styles.nameContainer}>
                  ...
                  <Text style={styles.infoText}>{student.city}</Text>
                  <Text style={styles.infoText}>{student.instrument}</Text>
                </View>
              </View>
            ))}
          </ScrollView>
